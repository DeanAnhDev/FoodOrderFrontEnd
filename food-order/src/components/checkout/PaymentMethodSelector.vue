<template>
    <div class="payment-selector">
        <label class="block mb-3 font-bold text-lg text-gray-700">Phương thức thanh toán</label>
        <div class="flex flex-col gap-4 w-full">
            <div v-for="m in methods" :key="m.id" @click="select(m)" :class="[
                'w-full cursor-pointer rounded-xl p-5 shadow-lg border-2 transition-all duration-200',
                ...
                <div class="flex items-center justify-between gap-3">
                    ...
                    <span class="font-semibold text-base text-gray-800">{{ m.label }}</span>
                    <span v-if="m.id === 'cod'" class="text-2xl">💵</span>
                    <span v-if="m.id === 'vnpay'" class="w-20 h-8 flex items-center justify-center">
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path class="cls-3" d="M29,14.89l-.75.74-1.31-1.32a.53.53,0,0,1,0-.75.53.53,0,0,1,.75,0Z" />
                            <path class="cls-3"
                            ...
                            <path class="cls-3" d="M22.33,21.53l0,0-.55.56-.18.17L17.43,18.1a.53.53,0,0,1,.75-.75Z" />
                            <path class="cls-4"
...
<script setup>
import { ref } from 'vue'
const emits = defineEmits(['update:selectedPaymentMethod'])
const methods = [
    { id: 'cod', label: 'Thanh toán khi nhận hàng (Tiền mặt)' },
...
const select = (m) => {
    ...
    emits('update:selectedPaymentMethod', m)
}
</script>
